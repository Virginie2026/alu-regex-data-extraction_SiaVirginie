...
# Global extraction of email addresses
...
# Strict Phone Regex (captures local/international formats without matching credit cards)
...
def main():
    ...
    official_alu = [e for e in all_emails if re.search(ALU_OFFICIAL_REGEX, e)]
    alumni_alu = [e for e in all_emails if re.search(ALU_ALUMNI_REGEX, e)]
    si_alu = [e for e in all_emails if re.search(ALU_SI_REGEX, e)]
